...
double total_calc() { // calcualates the total area

}
// include a function called total_area that computes the total surface area for the cylinder. 
// side area + 2x the cross-section 
// the area must be 27.2689